...
<div class="flex flex-col h-dvh w-full justify-center items-center gap-10">
    ...
    <form method="post" action="${pageContext.request.contextPath}/sign-in" class="flex flex-col gap-1 w-full max-w-md mx-auto px-2">
        <label for="email">
            Email
        </label>
        ...
        <input type="password" id="password" name="password" placeholder="Password"
               class="p-2 rounded border focus:outline-none focus:ring-zinc-900 focus:ring-2"/>
        <button type="submit" class="p-2 text-white bg-zinc-900 rounded hover:bg-zinc-600 transition-colors">로그인
        </button>
        <a href="${pageContext.request.contextPath}/sign-up" class="text-center text-gray-400 hover:text-black transition-colors">
            계정이 없으신가요?
        </a>
    </form>
</div>
